    ...
    def post(self, request):
        ...
        if srz_data.is_valid(raise_exception=True):
            ...
            try:
                ...
                return Response(
                    data={"message": "this product already added to your bookmarks"},
                ...
                return Response(
                    data={"message": "product added to your bookmarks"},
...
class DeleteBookmarkView(GenericAPIView):
    ...
    def delete(self, request, product_id):
        ...
        return Response(
            data={"message": "product deleted of bookmarks"}, status=status.HTTP_200_OK
        )


class UpdateBookmarkView(GenericAPIView):
    """
    delete a product in bookmarks if exists
    """
    ...
    def update(self, request, product_id):
        get_object_or_404(Bookmark, product__id=product_id).update()
        return Response(
            data={"message": "product update of bookmarks"}, status=status.HTTP_200_OK
        )
